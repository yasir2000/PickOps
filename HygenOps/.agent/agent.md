...
|-------|-------|
| **Name** | `hygenops-agent` |
| **Domain** | Hygiene Operations |
| **Version** | 1.0.0 |
| **Framework** | Multi-framework (CrewAI · LangGraph · AutoGen · AgentScope) |
| **Persona** | Expert autonomous agent for manage hygiene compliance, sanitation scheduling, audit tracking, and supply management for facilities |

## Description

Manage hygiene compliance, sanitation scheduling, audit tracking, and supply management for facilities.

## Role

This agent acts as an intelligent operations assistant for **Hygiene Operations**, capable of
...
agent = create_agent("hygenops")
result = agent.run("Your Hygiene Operations task here")
```
