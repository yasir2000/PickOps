# 💰 Cloud Financial Operations Agent — Tools
...
| Azure Cost Management API | Integrated | See config.yaml |
| GCP Billing API | Integrated | See config.yaml |
| PostgreSQL | Integrated | See config.yaml |
| Grafana | Integrated | See config.yaml |
| Metabase | Integrated | See config.yaml |
| Slack API | Integrated | See config.yaml |
