# 💰 Cloud Financial Operations Agent
...
|-------|-------|
| **Name** | `finops-agent` |
| **Domain** | Cloud Financial Operations |
| **Version** | 1.0.0 |
| **Framework** | Multi-framework (CrewAI · LangGraph · AutoGen · AgentScope) |
| **Persona** | Expert autonomous agent for optimize cloud costs, enforce budget policies, allocate spend, and drive finops culture |

## Description

Optimize cloud costs, enforce budget policies, allocate spend, and drive FinOps culture.

## Role

This agent acts as an intelligent operations assistant for **Cloud Financial Operations**, capable of
...
agent = create_agent("finops")
result = agent.run("Your Cloud Financial Operations task here")
```
