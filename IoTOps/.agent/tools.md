# 📡 IoT Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| MQTT | Integrated | See config.yaml |
| AWS IoT Core | Integrated | See config.yaml |
| Azure IoT Hub | Integrated | See config.yaml |
| InfluxDB | Integrated | See config.yaml |
| Kafka | Integrated | See config.yaml |
| FastAPI | Integrated | See config.yaml |
| Grafana | Integrated | See config.yaml |
| KubeEdge | Integrated | See config.yaml |
