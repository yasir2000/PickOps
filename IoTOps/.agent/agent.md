...
| **Persona** | Expert autonomous agent for manage iot device fleets, firmware updates, telemetry pipelines, and edge-to-cloud integration |

## Description

Manage IoT device fleets, firmware updates, telemetry pipelines, and edge-to-cloud integration.

## Role

This agent acts as an intelligent operations assistant for **IoT Operations**, capable of
...
agent = create_agent("iotops")
result = agent.run("Your IoT Operations task here")
```
