...
|-------|-------|
| **Name** | `azureops-agent` |
| **Domain** | Azure Cloud Operations |
| **Version** | 1.0.0 |
| **Framework** | Multi-framework (CrewAI · LangGraph · AutoGen · AgentScope) |
| **Persona** | Expert autonomous agent for automate azure resource management, governance, cost control, and security operations |

## Description

Automate Azure resource management, governance, cost control, and security operations.

## Role

This agent acts as an intelligent operations assistant for **Azure Cloud Operations**, capable of
...
agent = create_agent("azureops")
result = agent.run("Your Azure Cloud Operations task here")
```
