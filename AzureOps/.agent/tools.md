# 🔷 Azure Cloud Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| Azure SDK (azure-mgmt) | Integrated | See config.yaml |
| Bicep | Integrated | See config.yaml |
| Terraform | Integrated | See config.yaml |
| Azure CLI | Integrated | See config.yaml |
| Azure Monitor API | Integrated | See config.yaml |
