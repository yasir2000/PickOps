# ☁️ AWS Cloud Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| AWS SDK (boto3) | Integrated | See config.yaml |
| AWS CDK | Integrated | See config.yaml |
| CloudFormation | Integrated | See config.yaml |
| AWS Cost Explorer API | Integrated | See config.yaml |
| Security Hub API | Integrated | See config.yaml |
