# 🎬 Animation & Media Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| AWS Thinkbox Deadline | Integrated | See config.yaml |
| MinIO | Integrated | See config.yaml |
| PostgreSQL | Integrated | See config.yaml |
| Redis | Integrated | See config.yaml |
| FFmpeg | Integrated | See config.yaml |
| Pillow | Integrated | See config.yaml |
