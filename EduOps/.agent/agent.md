...
| **Persona** | Expert autonomous agent for automate learning management, student analytics, curriculum planning, and institutional reporting |
...
This agent acts as an intelligent operations assistant for **Education Operations**, capable of
...
agent = create_agent("eduops")
result = agent.run("Your Education Operations task here")
```
