...
| **Persona** | Expert autonomous agent for automate code quality, static analysis, dependency management, and developer productivity |

## Description

Automate code quality, static analysis, dependency management, and developer productivity.

## Role

This agent acts as an intelligent operations assistant for **Code Operations**, capable of
...
agent = create_agent("codeops")
result = agent.run("Your Code Operations task here")
```
