# 💻 Code Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| SonarQube API | Integrated | See config.yaml |
| Snyk API | Integrated | See config.yaml |
| GitHub API | Integrated | See config.yaml |
| GitLab API | Integrated | See config.yaml |
| Codecov API | Integrated | See config.yaml |
