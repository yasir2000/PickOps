# 🏺 Archaeological Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| PostgreSQL + PostGIS | Integrated | See config.yaml |
| QGIS API | Integrated | See config.yaml |
| MinIO | Integrated | See config.yaml |
| TensorFlow | Integrated | See config.yaml |
| OpenCV | Integrated | See config.yaml |
| FastAPI | Integrated | See config.yaml |
| Leaflet.js | Integrated | See config.yaml |
