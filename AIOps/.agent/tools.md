# 🧠 AI for IT Operations Agent — Tools
...
| Elasticsearch | Integrated | See config.yaml |
| Kafka | Integrated | See config.yaml |
| Scikit-learn | Integrated | See config.yaml |
| Prophet | Integrated | See config.yaml |
| PagerDuty API | Integrated | See config.yaml |
