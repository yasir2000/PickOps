...
| **Persona** | Expert autonomous agent for automate ci/cd pipelines, infrastructure as code, release management, and developer experience |
...
This agent acts as an intelligent operations assistant for **Development Operations**, capable of
...
result = agent.run("Your Development Operations task here")
```
