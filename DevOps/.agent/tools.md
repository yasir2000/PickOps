# 🔧 Development Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| GitHub Actions | Integrated | See config.yaml |
| GitLab CI | Integrated | See config.yaml |
| Terraform | Integrated | See config.yaml |
...
| Loki | Integrated | See config.yaml |
| Docker | Integrated | See config.yaml |
