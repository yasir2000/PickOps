# ✈️ Aviation Operations Agent — Tools
...
| Celery | Integrated | See config.yaml |
| FastAPI | Integrated | See config.yaml |
| Aviation Weather API | Integrated | See config.yaml |
| ACARS integration | Integrated | See config.yaml |
| PDF generator | Integrated | See config.yaml |
