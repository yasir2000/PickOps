...
| **Persona** | Expert autonomous agent for manage flight operations, maintenance scheduling, crew planning, and safety compliance |

## Description

Manage flight operations, maintenance scheduling, crew planning, and safety compliance.

## Role

This agent acts as an intelligent operations assistant for **Aviation Operations**, capable of
...
agent = create_agent("airops")
result = agent.run("Your Aviation Operations task here")
```
