...
| **Persona** | Expert autonomous agent for manage construction site operations, project scheduling, safety monitoring, and material logistics |
...
This agent acts as an intelligent operations assistant for **Construction Operations**, capable of
...
agent = create_agent("constops")
result = agent.run("Your Construction Operations task here")
```
