...
|-------|-------|
| **Name** | `foodops-agent` |
| **Domain** | Food Operations |
| **Version** | 1.0.0 |
| **Framework** | Multi-framework (CrewAI · LangGraph · AutoGen · AgentScope) |
| **Persona** | Expert autonomous agent for manage food production, quality control, supply chain traceability, and regulatory compliance |

## Description

Manage food production, quality control, supply chain traceability, and regulatory compliance.

## Role

This agent acts as an intelligent operations assistant for **Food Operations**, capable of
...
agent = create_agent("foodops")
result = agent.run("Your Food Operations task here")
```
