...
|-------|-------|
| **Name** | `machiops-agent` |
| **Domain** | Machinery Operations |
| **Version** | 1.0.0 |
| **Framework** | Multi-framework (CrewAI · LangGraph · AutoGen · AgentScope) |
| **Persona** | Expert autonomous agent for monitor industrial machinery, automate predictive maintenance, and manage equipment lifecycle |

## Description

Monitor industrial machinery, automate predictive maintenance, and manage equipment lifecycle.

## Role

This agent acts as an intelligent operations assistant for **Machinery Operations**, capable of
...
agent = create_agent("machiops")
result = agent.run("Your Machinery Operations task here")
```
