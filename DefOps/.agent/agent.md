...
|-------|-------|
| **Name** | `defops-agent` |
| **Domain** | Defence Operations |
| **Version** | 1.0.0 |
| **Framework** | Multi-framework (CrewAI · LangGraph · AutoGen · AgentScope) |
| **Persona** | Expert autonomous agent for manage defence systems operations, secure communications, mission planning, and logistics |
...
This agent acts as an intelligent operations assistant for **Defence Operations**, capable of
...
agent = create_agent("defops")
result = agent.run("Your Defence Operations task here")
```
