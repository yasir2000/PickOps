...
| **Persona** | Expert autonomous agent for automate vehicle fleet management, predictive maintenance, telematics, and ev charging operations |

## Description

Automate vehicle fleet management, predictive maintenance, telematics, and EV charging operations.

## Role

This agent acts as an intelligent operations assistant for **Automotive Operations**, capable of
...
agent = create_agent("autoops")
result = agent.run("Your Automotive Operations task here")
```
