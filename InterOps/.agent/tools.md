# 🔗 Interoperability Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| Apache Camel | Integrated | See config.yaml |
| n8n | Integrated | See config.yaml |
| MuleSoft API | Integrated | See config.yaml |
...
| OpenAPI Spec | Integrated | See config.yaml |
