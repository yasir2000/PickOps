...
|-------|-------|
| **Name** | `electops-agent` |
| **Domain** | Electronics Operations |
| **Version** | 1.0.0 |
| **Framework** | Multi-framework (CrewAI · LangGraph · AutoGen · AgentScope) |
| **Persona** | Expert autonomous agent for manage electronics manufacturing, pcb design workflows, test automation, and supply chain |

## Description

Manage electronics manufacturing, PCB design workflows, test automation, and supply chain.

## Role

This agent acts as an intelligent operations assistant for **Electronics Operations**, capable of
...
agent = create_agent("electops")
result = agent.run("Your Electronics Operations task here")
```
