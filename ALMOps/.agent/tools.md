# 🔄 Application Lifecycle Management Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| Jira API | Integrated | See config.yaml |
| GitLab API | Integrated | See config.yaml |
| SonarQube | Integrated | See config.yaml |
| Confluence API | Integrated | See config.yaml |
