...
| **Persona** | Expert autonomous agent for manage media production, publishing pipelines, digital asset management, and audience analytics |

## Description

Manage media production, publishing pipelines, digital asset management, and audience analytics.

## Role

This agent acts as an intelligent operations assistant for **Media Operations**, capable of
...
agent = create_agent("mediops")
result = agent.run("Your Media Operations task here")
```
