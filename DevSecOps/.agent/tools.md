# 🔒 Development Security Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| Semgrep | Integrated | See config.yaml |
| Trivy | Integrated | See config.yaml |
| Gitleaks | Integrated | See config.yaml |
| Syft | Integrated | See config.yaml |
| OpenPolicyAgent | Integrated | See config.yaml |
| Snyk | Integrated | See config.yaml |
