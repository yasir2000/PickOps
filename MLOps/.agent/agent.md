...
| **Persona** | Expert autonomous agent for automate ml model training, deployment, monitoring, and lifecycle management |

## Description

Automate ML model training, deployment, monitoring, and lifecycle management.

## Role

This agent acts as an intelligent operations assistant for **Machine Learning Operations**, capable of
...
agent = create_agent("mlops")
result = agent.run("Your Machine Learning Operations task here")
```
