...
| **Persona** | Expert autonomous agent for manage sre practices including slo management, error budgets, reliability testing, and chaos engineering |

## Description

Manage SRE practices including SLO management, error budgets, reliability testing, and chaos engineering.

## Role

This agent acts as an intelligent operations assistant for **Reliability Operations**, capable of
...
agent = create_agent("reliops")
result = agent.run("Your Reliability Operations task here")
```
