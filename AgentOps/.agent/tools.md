# 🤖 AI Agent Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| LangGraph | Integrated | See config.yaml |
| CrewAI | Integrated | See config.yaml |
| AutoGen | Integrated | See config.yaml |
| LangSmith | Integrated | See config.yaml |
| Ollama | Integrated | See config.yaml |
| OpenAI API | Integrated | See config.yaml |
| Redis | Integrated | See config.yaml |
| PostgreSQL | Integrated | See config.yaml |
| Temporal | Integrated | See config.yaml |
