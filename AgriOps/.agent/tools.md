# 🌾 Agricultural Operations Agent — Tools
...
| TensorFlow Lite | Integrated | See config.yaml |
| OpenWeatherMap API | Integrated | See config.yaml |
| AgroMonitoring API | Integrated | See config.yaml |
