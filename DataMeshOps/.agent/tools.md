# 🕸️ Data Mesh Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| DataHub | Integrated | See config.yaml |
| Great Expectations | Integrated | See config.yaml |
| dbt | Integrated | See config.yaml |
| PostgreSQL | Integrated | See config.yaml |
| Kafka | Integrated | See config.yaml |
| OpenLineage | Integrated | See config.yaml |
