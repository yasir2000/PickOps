...
| **Persona** | Expert autonomous agent for manage music production, distribution, rights management, and artist analytics |
...
This agent acts as an intelligent operations assistant for **Music Operations**, capable of
...
agent = create_agent("musicops")
result = agent.run("Your Music Operations task here")
```
