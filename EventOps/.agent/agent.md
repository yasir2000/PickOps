...
| **Persona** | Expert autonomous agent for automate event planning, registration, ticketing, logistics, and post-event analytics |

## Description

Automate event planning, registration, ticketing, logistics, and post-event analytics.

## Role

This agent acts as an intelligent operations assistant for **Event Operations**, capable of
...
agent = create_agent("eventops")
result = agent.run("Your Event Operations task here")
```
