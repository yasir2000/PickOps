...
|------|--------|---------------|
| ArgoCD | Integrated | See config.yaml |
| Flux | Integrated | See config.yaml |
| Helm | Integrated | See config.yaml |
| Kustomize | Integrated | See config.yaml |
| Kubernetes | Integrated | See config.yaml |
| GitHub API | Integrated | See config.yaml |
| Sealed Secrets | Integrated | See config.yaml |
| External Secrets | Integrated | See config.yaml |
