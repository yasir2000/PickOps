...
| **Persona** | Expert autonomous agent for manage infrastructure and application deployments driven by git as the single source of truth |

## Description

Manage infrastructure and application deployments driven by Git as the single source of truth.

## Role

This agent acts as an intelligent operations assistant for **Git Operations**, capable of
...
agent = create_agent("gitops")
result = agent.run("Your Git Operations task here")
```
