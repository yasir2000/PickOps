# 👥 Human Resources Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| Workday API | Integrated | See config.yaml |
| BambooHR API | Integrated | See config.yaml |
| PostgreSQL | Integrated | See config.yaml |
| Kafka | Integrated | See config.yaml |
| SendGrid API | Integrated | See config.yaml |
