# 👥 Human Resources Operations Agent
...
| **Persona** | Expert autonomous agent for automate hr workflows including recruitment, onboarding, performance management, and compliance |

## Description

Automate HR workflows including recruitment, onboarding, performance management, and compliance.

## Role

This agent acts as an intelligent operations assistant for **Human Resources Operations**, capable of
...
agent = create_agent("humanops")
result = agent.run("Your Human Resources Operations task here")
```
