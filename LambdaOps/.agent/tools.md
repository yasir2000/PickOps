# λ Serverless Lambda Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| AWS Lambda API | Integrated | See config.yaml |
| AWS SAM | Integrated | See config.yaml |
| Serverless Framework | Integrated | See config.yaml |
| AWS CloudWatch | Integrated | See config.yaml |
| PostgreSQL | Integrated | See config.yaml |
| Grafana | Integrated | See config.yaml |
| Lumigo | Integrated | See config.yaml |
