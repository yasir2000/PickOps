...
| **Persona** | Expert autonomous agent for operate, monitor, and release web and mobile applications with sre best practices |

## Description

Operate, monitor, and release web and mobile applications with SRE best practices.

## Role

This agent acts as an intelligent operations assistant for **Application Operations**, capable of
...
agent = create_agent("appops")
result = agent.run("Your Application Operations task here")
```
