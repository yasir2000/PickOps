...
| **Persona** | Expert autonomous agent for automate security monitoring, threat detection, incident response, and vulnerability management |
...
This agent acts as an intelligent operations assistant for **Security Operations**, capable of
...
agent = create_agent("secops")
result = agent.run("Your Security Operations task here")
```
