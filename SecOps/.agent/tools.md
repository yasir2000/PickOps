# 🔐 Security Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| Wazuh | Integrated | See config.yaml |
| Elastic SIEM | Integrated | See config.yaml |
| TheHive | Integrated | See config.yaml |
| Cortex | Integrated | See config.yaml |
| OpenCTI | Integrated | See config.yaml |
| Shuffle SOAR | Integrated | See config.yaml |
