...
| Field | Value |
|-------|-------|
| **Name** | `healthops-agent` |
| **Domain** | Healthcare Operations |
| **Version** | 1.0.0 |
| **Framework** | Multi-framework (CrewAI · LangGraph · AutoGen · AgentScope) |
| **Persona** | Expert autonomous agent for automate healthcare workflows including patient management, clinical documentation, and compliance |

## Description

Automate healthcare workflows including patient management, clinical documentation, and compliance.

## Role

This agent acts as an intelligent operations assistant for **Healthcare Operations**, capable of
...
agent = create_agent("healthops")
result = agent.run("Your Healthcare Operations task here")
```
