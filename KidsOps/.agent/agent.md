...
|-------|-------|
| **Name** | `kidsops-agent` |
| **Domain** | Kids & Family Operations |
| **Version** | 1.0.0 |
| **Framework** | Multi-framework (CrewAI · LangGraph · AutoGen · AgentScope) |
| **Persona** | Expert autonomous agent for manage child-safe digital experiences, parental controls, educational content, and activity scheduling |

## Description

Manage child-safe digital experiences, parental controls, educational content, and activity scheduling.

## Role

This agent acts as an intelligent operations assistant for **Kids & Family Operations**, capable of
...
agent = create_agent("kidsops")
result = agent.run("Your Kids & Family Operations task here")
```
