# 🗺️ Domain-Driven Design Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| Miro API | Integrated | See config.yaml |
| PlantUML | Integrated | See config.yaml |
| EventStorming tools | Integrated | See config.yaml |
