# 📚 Retrieval-Augmented Generation Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| Qdrant | Integrated | See config.yaml |
| Weaviate | Integrated | See config.yaml |
| Chroma | Integrated | See config.yaml |
| LangChain | Integrated | See config.yaml |
| LlamaIndex | Integrated | See config.yaml |
