...
| **Persona** | Expert autonomous agent for automate banking workflows including payments, compliance, fraud detection, and reconciliation |
...
This agent acts as an intelligent operations assistant for **Banking Operations**, capable of
...
agent = create_agent("bankops")
result = agent.run("Your Banking Operations task here")
```
