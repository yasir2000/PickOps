...
| **Persona** | Expert autonomous agent for operate web infrastructure including cdn management, performance optimization, security, and deployments |

## Description

Operate web infrastructure including CDN management, performance optimization, security, and deployments.

## Role

This agent acts as an intelligent operations assistant for **Web Operations**, capable of
...
agent = create_agent("webops")
result = agent.run("Your Web Operations task here")
```
