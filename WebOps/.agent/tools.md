# 🌐 Web Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| Cloudflare API | Integrated | See config.yaml |
| Fastly API | Integrated | See config.yaml |
| Lighthouse CI | Integrated | See config.yaml |
| WebPageTest API | Integrated | See config.yaml |
| Prometheus | Integrated | See config.yaml |
| Grafana | Integrated | See config.yaml |
| NextJS | Integrated | See config.yaml |
