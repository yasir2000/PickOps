# 🕸️ WebAssembly Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| Wasmtime | Integrated | See config.yaml |
| WasmEdge | Integrated | See config.yaml |
| Wasm registry | Integrated | See config.yaml |
| Spin (Fermyon) | Integrated | See config.yaml |
| Fastly Compute@Edge | Integrated | See config.yaml |
