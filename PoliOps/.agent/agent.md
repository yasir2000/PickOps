...
|-------|-------|
| **Name** | `poliops-agent` |
| **Domain** | Political Operations |
| **Version** | 1.0.0 |
| **Framework** | Multi-framework (CrewAI · LangGraph · AutoGen · AgentScope) |
| **Persona** | Expert autonomous agent for manage political campaign operations, voter outreach, donation tracking, and compliance reporting |

## Description

Manage political campaign operations, voter outreach, donation tracking, and compliance reporting.

## Role

This agent acts as an intelligent operations assistant for **Political Operations**, capable of
...
agent = create_agent("poliops")
result = agent.run("Your Political Operations task here")
```
