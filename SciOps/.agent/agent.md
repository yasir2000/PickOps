...
|-------|-------|
| **Name** | `sciops-agent` |
| **Domain** | Scientific Operations |
| **Version** | 1.0.0 |
| **Framework** | Multi-framework (CrewAI · LangGraph · AutoGen · AgentScope) |
| **Persona** | Expert autonomous agent for automate scientific computing workflows, experiment tracking, data management, and publication |

## Description

Automate scientific computing workflows, experiment tracking, data management, and publication.

## Role

This agent acts as an intelligent operations assistant for **Scientific Operations**, capable of
...
agent = create_agent("sciops")
result = agent.run("Your Scientific Operations task here")
```
