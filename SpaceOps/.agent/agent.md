...
| **Persona** | Expert autonomous agent for manage space mission operations including telemetry processing, satellite management, and ground systems |

## Description

Manage space mission operations including telemetry processing, satellite management, and ground systems.

## Role

This agent acts as an intelligent operations assistant for **Space Operations**, capable of
...
agent = create_agent("spaceops")
result = agent.run("Your Space Operations task here")
```
