...
| **Persona** | Expert autonomous agent for automate compliance monitoring, policy enforcement, audit trail management, and regulatory reporting |
...
This agent acts as an intelligent operations assistant for **Compliance Operations**, capable of
...
agent = create_agent("compops")
result = agent.run("Your Compliance Operations task here")
```
