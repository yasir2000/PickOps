# 🏛️ Architecture & Design Operations Agent — Tools
...
| IFC.js | Integrated | See config.yaml |
| Autodesk Forge API | Integrated | See config.yaml |
| FastAPI | Integrated | See config.yaml |
| React | Integrated | See config.yaml |
