...
| **Persona** | Expert autonomous agent for manage furniture manufacturing, custom orders, inventory, and delivery logistics |

## Description

Manage furniture manufacturing, custom orders, inventory, and delivery logistics.

## Role

This agent acts as an intelligent operations assistant for **Furniture Operations**, capable of
...
agent = create_agent("furnops")
result = agent.run("Your Furniture Operations task here")
```
