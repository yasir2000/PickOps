...
| **Persona** | Expert autonomous agent for automate farm management including crop planning, equipment tracking, and supply chain |
...
This agent acts as an intelligent operations assistant for **Farm Operations**, capable of
...
agent = create_agent("farmops")
result = agent.run("Your Farm Operations task here")
```
