# ⛓️ Blockchain Operations Agent — Tools

## Tool Inventory

| Tool | Status | Configuration |
|------|--------|---------------|
| Web3.py | Integrated | See config.yaml |
| Hardhat | Integrated | See config.yaml |
| Ethers.js | Integrated | See config.yaml |
| Infura/Alchemy API | Integrated | See config.yaml |
